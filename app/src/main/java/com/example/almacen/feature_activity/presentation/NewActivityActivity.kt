...
import com.example.almacen.feature_activity.presentation.ui.NewActivityScreen
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class NewActivityActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            AlmacenTheme {
                NewActivityScreen(
                    onBack = { finish() },
                    onCreated = { id ->                 // <— nuevo callback del screen
                        startActivity(
